- Patched to run in the second half of a 512k cart
- binary manually patched to remove the AA byte from the first and last pages
...
Now also includes a ColecoVision cart, though this is 512k for various reasons. It should work on Phoenix as well as real ColecoVision.
