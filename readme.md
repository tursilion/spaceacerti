...
29 June 2023
- Updating everything for the newest SDCC toolchain
- update music to vgmcomp2
- reimplement some lost code
- performance optimizations
- difficulty tuning
- attract mode (AI art)
- homing shots for secret ship
- replace boss graphics (AI shaded)

7 July 2023
- added sound effects via AY
- mute music (and get sound effects on SN) with '#'
- add secret 'use the force' bonus (think Atari Star Wars)
- save power level when changing weapon type
- adjust level lengths
- add sfx test to music test ('0' on difficulty screen)
- add end routine for Ladybird
- add end routine for other secret character
- more difficulty tuning
- some minor code cleanup
- change attacks of boss 4 and boss 5 - should be more interesting and more fair
