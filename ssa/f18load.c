...
void initSnowballf18() {
    ...
    vdpmemcpy(108*8+0x1800, &F18SNOWBALL3[0*8], 4*4*8);	    // ship straight sprites layer 2
    vdpmemcpy(140*8+0x1800, &F18SNOWBALL3[16*8], 4*4*8);	// ship left sprites layer 2
    vdpmemcpy(172*8+0x1800, &F18SNOWBALL3[32*8], 4*4*8);	// ship right sprites layer 2
    // shields
